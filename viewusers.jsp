...
String qry="select * from CUSTOMER_REGISTRATION";
              ...
              <tr> 
                ...
                <td width="75%"><div align="center"> 
                  ...
                  <table width="100%" height="75" border="0"  colspan="9">
                    <tr> 
                      <td width="7%" height="31"><font color="#FFCC33">ID</font></td>
                      <td width="13%"><font color="#FFCC33">FNAME</font></td>
                      <td width="12%"><font color="#FFCC33">LNAME</font></td>
                      <td width="9%"><font color="#FFCC33">ADD</font></td>
                      <td width="13%"><font color="#FFCC33">UNAME</font></td>
                      <td width="10%"><font color="#FFCC33">PASS</font></td>
                      <td width="12%"><font color="#FFCC33">PHNO</font></td>
                      <td width="12%"><font color="#FFCC33">EMAIL</font></td>
					...
					String name=rs.getString(5);
					  %>
                    <tr> 
                      <td height="38"><font color="#FF6600"><%=rs.getString(1)%></font>&nbsp;</td>
                      ...
                      <td><font color="#FF6600"><%=name%></font>&nbsp;</td>
                      <td><font color="#FF6600"><%=rs.getString(6)%></font>&nbsp;</td>
                      <td><font color="#FF6600"><%=rs.getString(7)%></font>&nbsp;</td>
                      <td><font color="#FF6600"><%=rs.getString(8)%></font>&nbsp;</td>
                      <td><font color="#FF6600"><a href='deleteuser.jsp?name=<%=name%>'><font color="#FF6600">click Here</font></a></font></td>&nbsp;</td>
                    </tr>
                    <%}
					  }
					  catch(Exception e)
