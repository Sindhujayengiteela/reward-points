...
try
{
   ...
   con=DConnection.connect();
	...
	ResultSet rs=st.executeQuery("select max(sno) from adds ");
	if(rs.next())
	{
		i=rs.getInt(1);
		i++;
              ...
              <td width="25%" height="463"><img src="images/images.jpg" width="309" height="463"></td>
                <td width="75%"><div align="center"> 
                    <table width="83%" border="0">
                      <tr> 
                        <td colspan="2"><div align="center"><font color="#FF6600" size="5" face="Goudy Stout, Haettenschweiler, Harlow Solid Italic">ADVERTIZEMENT</font></div></td>
                      </tr>
                      <tr> 
                      ...
                      <tr> 
                        <td><font color="#FF9900" size="4">ADDNAME:</font></td>
                        <td><input type="text" name="ADDNAME"></td>
                      </tr>
                      <tr> 
                        <td height="94"><font color="#FF9900" size="4">DESCRIPTION:</font></td>
                        <td><textarea name="DESCRIPTION"></textarea></td>
                      </tr>
                      <tr> 
                        <td><font color="#FF9900" size="4">OWNERNAME:</font></td>
