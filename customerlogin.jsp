...
ResultSet rs=st.executeQuery(qry);
 name1=(String)application.getAttribute("name");
out.println("dgf"+name1);
      ...
      <td height="487" colspan="2"><div align="center"> 
            <table width="100%" height="481" border="0">
              <tr> 
                ...
                <td width="75%"><p><font color="#99CC00" size="4">hi <%=name1%>,welcome 
                  to reward schemes</font></p>
                <p><font color="#99CC00" size="4">do you want to change ur password<a href="change.html"> 
                  <font color="#FF6600" size="5">click here</font></a></font></p>
                <p><font color="#99CC00" size="4"><a href='choose.jsp?name=<%=name1%>'><font color="#FF6600" size="5">choose 
                  gift</font></a></font></p>
                <div align="center"> 
                    <table width="100%" height="75" border="0"  colspan="4">
                      <tr> 
					  <td width="13%"><font color="#FFCC33">click Here</font></td>
                        <td width="13%"><font color="#FFCC66">SNO</font></td>
                        <td width="12%"><font color="#FFCC33">ADDNAME</font></td>
                        <td width="13%"><font color="#FFCC33">OWNERNAME</font></td>
                       </tr>
					  <%while(rs.next())
					  {
					String sno=rs.getString(1);
					  %>
                      <tr> 
					  <td><font color="#FF6600"><a href='addpoints.jsp?sno=<%=sno%>&name=<%=name1%>'><font color="#FF6600">click Here</font></a></font></td>
                        <td height="38"><font color="#FF6600"><%=sno%></font>&nbsp;</td>
