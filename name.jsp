...
%><body>
<form name="form1" method="post" action="monthpoints.jsp">
<div align="center">
            ...
            <tr> 
              ...
              <td width="75%"><div align="center">
                  <table width="83%" border="0">
                    <tr> 
                      <td width="33%"><font color="#FFCC33" size="4">username:</font></td>
                      <td width="67%">
                    ...
                    <tr> 
                      <td colspan="2"><div align="center">
                            <a href='monthpoints.jsp?name=<%=name1%>'><input type="submit" name="Submit" value="Submit">
                          </a></div></td>
                    </tr>
                  </table>
                </div>
