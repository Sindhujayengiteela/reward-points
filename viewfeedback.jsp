            ...
            <table width="100%" height="481" border="0">
              <tr> 
                ...
                <td width="75%"><div align="center"> 
                    <table width="100%" height="75" border="0"  colspan="3">
                      <tr> 
                        <td width="13%"><font color="#FFCC66">USERID</font></td>
                        <td width="12%"><font color="#FFCC33">USERNAME</font></td>
                        <td width="13%"><font color="#FFCC33">FEEDBACK</font></td>
                        </tr>
					  <%while(rs.next())
					  {%>
                      <tr> 
