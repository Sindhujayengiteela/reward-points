                ...
                <td width="75%"><div align="center"> 
                  ...
                  <table width="100%" height="75" border="0"  colspan="9">
                    <tr> 
                      ...
                      <td width="13%"><font color="#FFCC33">GIFTNAME</font></td>
                      <td width="13%"><font color="#FFCC33">IMAGE</font></td>
                      <td width="12%"><font color="#FFCC33">CHOOSE</font></td>
                    </tr>
                    <%while(rs.next())
					{
					out.println("1");
                    ...
                    <tr> 
                      ...
                      <td><font color="#FF6600"><%=gname%></font>&nbsp;</td>
                      <td><font color="#FF6600"><image src="<%=rs.getString(3)%>"></font>&nbsp;</td>
                     <td><font color="#FF6600"><a href='reward.jsp?sno=<%=sno1%>&uname=<%=name1%>&gname=<%=gname%>'><font color="#FF6600">click Here</font></a></font></td>
                    </tr>
                    <%
					}
					  }
