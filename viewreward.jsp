            ...
            <table width="100%" height="481" border="0">
              <tr> 
                ...
                <td width="75%"><div align="center"> 
                  ...
                  <table width="100%" height="248" border="0"  colspan="9">
                    <tr> 
                      <td width="7%" height="31"><font color="#FFCC33">SNO</font></td>
                      <td width="13%"><font color="#FFCC33">USERNAME</font></td>
                      <td width="13%"><font color="#FFCC33">GIFTNAME</font></td>
                      <td width="12%"><font color="#FFCC33">DATE</font></td>
                    </tr>
                    <%while(rs.next())
					{
					out.println("1");
					String sno1=rs.getString(1);
					  %>
                    <tr> 
                      <td height="211"><font color="#FF6600"><%=sno1%></font>&nbsp;</td>
                      <td><font color="#FF6600"><%=rs.getString(2)%></font>&nbsp;</td>
                      <td><font color="#FF6600"><%=rs.getString(3)%></font>&nbsp;</td>
                      <td><font color="#FF6600"><%=rs.getString(4)%></font></a></font></td></tr>
                    <%}
					  }
					  catch(Exception e)
					  {
